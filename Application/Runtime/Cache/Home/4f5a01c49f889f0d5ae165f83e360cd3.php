...
<html lang="utf-8">
	<head>
		...
		<title>公告管理</title>                       <!--网页标题-->
        <meta name="description" content="公告管理">  <!--网页介绍-->
        <META NAME ="keywords" CONTENT="公告管理">    <!--搜索关键词-->
        <link rel="stylesheet" href="/SmallCrm/Public/css/bootstrap.min.css">
 		<link rel="stylesheet" href="/SmallCrm/Public/css/notice/delnotice.css">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
	...
	<form action="<?php echo U('/Home/Index/delnoticeform');?>" method="post">
		<div class="container">
			<div class="panel panel-info">
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-xs-4 col-sm-4 col-md-2">
							<p class="text-center">发布人</p>
						</div>
						<div class="col-xs-4 col-sm-4 col-md-2">
							<p class="text-center">发布时间</p>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-6">
							<p class="text-center">发布内容</p>
						</div>
					</div>
				</div>
				<div class="panel-body">
					<?php if(is_array($result)): foreach($result as $key=>$v): ?><div class="row ">
							<div class="col-xs-2 col-sm-2 col-md-1 notice-body">
								<label><input type="checkbox" name="delid[]" id="id" value="<?php echo ($v["id"]); ?>"></label>
							</div>
							<div class="col-xs-2 col-sm-2 col-md-1 notice-body">
								<p class="text-center"><?php echo ($v["id"]); ?></p>
							</div>
							<div class="col-xs-4 col-sm-4 col-md-2 notice-body">
								<p class="text-center"><?php echo ($v["username"]); ?>(<?php echo ($v["name"]); ?>)</p>
							</div>
							<div class="col-xs-4 col-sm-4 col-md-2 notice-body">
								<p class="text-center"><?php echo (date("Y-m-d H:i",$v["addtime"])); ?></p>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-6 notice-body notice-text">
								<p class="text-center"><?php echo ($v["text"]); ?></p>
							</div>
				...
				<div class="panel-footer">
					<div class="container">
						<div class="row">
							<div class="col-xs-4 col-sm-4 col-md-4 col-offset-xs-2 col-offset-sm-2 col-offset-md-2">
